...
复制以下代码到Application层下的：YhyApplicationModule.cs
...
如果你生成了**权限功能**。复制以下代码到 YhyApplicationModule.cs
中的 PreInitialize 方法中:
...
<text name="NameTXT"  value="NameTXT"></text>
<text name="OverTime"  value="OverTime"></text>
<text name="Bumens"  value="Bumens"></text>
<text name="Users"  value="Users"></text>
<text name="MaxPersons"  value="MaxPersons"></text>


<text name="Complays" value=""></text><text name="QueryComplays"  value="查询"></text><text name="CreateComplays"  value="添加"></text><text name="EditComplays"  value="编辑"></text><text name="DeleteComplays"  value="删除"></text><text name="BatchDeleteComplays" value="批量删除"></text><text name="ExportComplays"  value="导出"></text>                             
