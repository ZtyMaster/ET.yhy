...
{
    public partial class NEWmigration0001 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ComplaysId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompalysId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Bumen", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Bumen_Complays_CompalysId",
                        column: x => x.CompalysId,
                        principalSchema: "Yhy",
                        principalTable: "Complays",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
